...
# a) typ mieszkania w porównaniu do ilości ? moze zamienic na cos ineego 
...
print(dfSummary(dane_clean, style = "grid"), method = "render")
...
tab1 <- dane_clean %>%
  select(-price) %>%  # jeśli price jest zmienną docelową, często daje się osobno; ale możesz zostawić
  tbl_summary(
    statistic = list(
